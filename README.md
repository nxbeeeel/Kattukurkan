...
![GitHub Repo stars](https://img.shields.io/github/stars/DalinMathew/Kattukurkanbot?style=social)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/nxbeeeel/Kattukurkan
```bash
